package org.delta.newChunk.modules;
...
import org.delta.newChunk.Addon;
            ...
            synchronized (newChunks) {
                for (ChunkPos c : newChunks) {
                    if (mc.getCameraEntity().getBlockPos().isWithinDistance(c.getStartPos(), 1024)) {
                        render(new Box(Vec3d.of(c.getStartPos()), Vec3d.of(c.getStartPos()).add(16, renderHeight.get(), 16)),
